...
class Net(nn.Module):
	def __init__(self):
		...
		self.conv2 =conv_nalu.NALU_conv2d(16, 16, kernel_size=3, padding=1)
		self.conv2_bn = nn.BatchNorm2d(16)
		self.conv3 =conv_nalu.NALU_conv2d(16, 32, kernel_size=3, padding=1)
		self.conv3_bn = nn.BatchNorm2d(48)
		self.conv4 = conv_nalu.NALU_conv2d(48, 1, kernel_size=1, padding=0)
		...
		self.gru7 = nn.GRUCell(125+96, 125+96)
		self.nalu2 = nalu.NALU(125+96, 125)
